...
- Bedrock Dedicated Server, PocketMine-MP, Nukkit, Cloudburst Nukkit, and Geyser expose dedicated management profiles for RakNet UDP, default port `19132`, configuration files, extension capabilities, and declared extension directories. Panel can ask Core to distinguish an available, occupied, or unavailable default UDP port.
