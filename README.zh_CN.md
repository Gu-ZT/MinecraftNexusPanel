...
- Bedrock Dedicated Server、PocketMine-MP、Nukkit、Cloudburst Nukkit 与 Geyser 使用专门画像管理 RakNet UDP、默认端口 `19132`、配置文件、扩展能力和声明的扩展目录。Panel 可要求 Core 区分默认 UDP 端口可用、已占用或不可用。
